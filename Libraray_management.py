...
if __name__ == "__main__":
    ...
    print("\t\t\t\t\t♦♦♦♦♦♦♦ WELCOME TO THE MIET LIBRARY ♦♦♦♦♦♦♦\n")
    ...
    while (True):
        ...
        try:
            ...
            if usr_response == 1:  # listing
                Mietlibrary.displayAvailableBooks()
            elif usr_response == 2:  # borrow
                Mietlibrary.borrowBook(
                    input("Enter your name: "), student.requestBook())
            elif usr_response == 3:  # return
                Mietlibrary.returnBook(student.returnBook())
            elif usr_response == 4:  # donate
                Mietlibrary.donateBook(student.donateBook())
